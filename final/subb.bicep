...
//   Role assignment of APIM's managed identity as "Cognitive Services OpenAI
//   User" on both Sub C resources (foundry-services-applications13-dev and
//   testing-chatappmodel-2). Without this, the policy above will authenticate
//   fine but get a 403 from Sub C, since the identity has no RBAC grant yet.
// ============================================================================

output apimPrincipalId string = apim.identity.principalId
output gatewayUrl string = 'https://${apim.properties.gatewayUrl}/${apiSuffix}/openai/v1'
output backendPoolName string = backendPool.name
// Subscription key value isn't directly output-able from this resource type
// for security reasons — fetch it post-deploy with:
//   az apim subscription show --service-name <apimName> --sid sub-a-agent-subscription --resource-group <rg> --query primaryKey
