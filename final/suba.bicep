...
param mcpKeyConnectionName string = 'mcp-servicenow'
...
resource connection 'Microsoft.CognitiveServices/accounts/projects/connections@2025-06-01' = {
  ...
  properties: {
    ...
    metadata: {
      deploymentInPath: string(deploymentInPath)
      models: string([
        {
          name: modelName
...
output mcpKeyConnectionId string = mcpKeyConnection.id
output mcpKeyConnectionName string = mcpKeyConnection.name
// ============================================================================
