          ...
          >
            <div className="flex justify-between  w-full mx-auto p-4 bg-black fixed">
              ...
              <div className="flex gap-[10px] items-center">
                <button className="border rounded-[9999px] p-1.5 bg-[#004B2B] text-white hover:text-[#FFC72C] text-l border-white cursor-pointer transition-all duration-200 hover:border-[#FFC72C]">Dashboard</button>
